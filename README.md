...
7. Start the app from the desktop shortcut or Start menu
...
4. Run the main app file inside it
...
### Step 5: Set up private search and network tools
...
## 🪟 Using sovereign-stack on Windows
...
## 📚 Suggested order for most users
...
degoogle, digital-freedom, firefox, foss, immich, linux, nextcloud, open-source, privacy, privacy-tools, searxng, self-hosted, sovereign, vaultwarden, wireguard
...
Move one service at a time. Keep what works. Replace what you do not want to keep.